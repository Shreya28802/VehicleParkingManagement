      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                    ...
                    <h5 class="centered"> Attendant</h5>
      ...
      <section id="main-content">
          <section class="wrapper">
               ...
               /* $id_customer=$row['id_customer'];*/
                ...
                <td><a href="edit5.php? edit=<?php echo $name; ?>">Edit</a</td>
                <td><a href="basic_table6.php?delete=<?php echo $name; ?>">Delete</a></td>
                </tr>
                <?php }?>
                </table>
                <?php
                if(isset($_GET['delete']))
                {
                  ...
                  if($run_delete)
                  {
                    ...
                    echo "<script>window.open('basic_table6.php','_self')</script>";
                  }
                }
                ?>
	                  	  </div>

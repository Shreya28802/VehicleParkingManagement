...
if(isset($_GET['edit'])){
    ...
    $sel="select * from parkings where location='$edit_id'";
  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
        ...
        <div class="form-group">
          <div class="col-sm-10">
            <input type="text" class="form-control"  placeholder="area" name="area" value="<?php echo $area; ?>" />
          </div>
        </div>
        <div class="form-group">
          <div class="col-sm-10">
            <input type="text" class="form-control"  placeholder="slot" name="slot" value="<?php echo $slot; ?>" />
          </div>
        </div>
        <div class="form-group">
          <div class="col-sm-10">
            <input type="text" class="form-control" placeholder="remaining_slots" name="remaining_slots" value="<?php echo $remaining_slots; ?>" />
          </div>
        </div>
        <div class="form-group">
          <div class="col-sm-10">
            <input type="text" class="form-control" placeholder="rent" name="rent" value="<?php echo $rent; ?>" />
          </div>
        </div>
        <div class="form-group">
...
if(isset($_POST['update'])){
  ...
  $update="UPDATE `parkings` SET `location` = '$location', `area` = '$area',`slot` = '$slot','remaining_slots'='$remaining_slots', `rent` = '$rent' WHERE `parkings`.`location`='$edit_id';";
    $run_update=mysqli_query($con,$update);
    if($run_update){
      echo"<script>alert('Successful updated')</script>";
      echo"<script>window.open('basic_table4.php','_self')</script>";

      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper site-min-height">
          	<h3><i class="fa fa-angle-right"></i> Add  customer Details</h3>
          	<div class="row mt">
          		<div class="col-lg-12">
        ...
        <div class="form-group">
          ...
          <div class="form-group">
          <div class="col-sm-10">
            <input type="text" class="form-control" placeholder="vehicle_id" name="vehicle_id">
          </div>
          </div>
          <div class="form-group">
          <div class="col-sm-10">
          ...
          <div class="col-sm-10">
              <select name="location" class="form-control">
                <option value="">status</option>
                 <option value="Tudor">active</option>
                 <option value="Kizingo">deactive</option>
...
if(isset($_POST['sub'])){
  ...
  $status = password_hash($_POST['status'], PASSWORD_DEFAULT);

  if($name==''&& $address==''&& $contact=='' && $area=='' && $vehicle_id=='' && $date=='' && $status==''){
		echo"<script>alert('please fill all field')</script>";
      echo"<script>window.open('attendant1.php','_self')</script>";
		exit();
	}
  else{

		$insert="INSERT INTO `customer` (`name`, `address`, `contact`, `area`, `vehicle_id`,`date`,`status`) VALUES (NULL, '$name', '$addredd', '$contact', '$area','$vehicle_id','$date','$status');";

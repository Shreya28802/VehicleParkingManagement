...
<div class="form-group">
          <div class="col-sm-10">
          <h5>Parking area</h5>
            <input type="text" class="form-control" placeholder="parking area" name="area"><br>
          </div>
        </div>    
        ...
        <div class="form-group">
          <div class="col-sm-10">
          <h5> Total Slot</h5>
            <input type="text" class="form-control" placeholder="slot" name="slot"><br>
          </div>
        </div>
        <!--<div class="form-group">
          <div class="col-sm-10">
            <input type="text" class="form-control" placeholder="Number of remaining slot" name="remaining_slots"><br>
          </div>              
          </div>-->
        ...
        <div class="col-sm-10">
        <h5>Rent</h5>
            <input type="text" class="form-control" placeholder="Rent" name="rent"><br>
          </div>
</div>
